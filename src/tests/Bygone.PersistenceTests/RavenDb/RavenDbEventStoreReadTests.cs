...
namespace Bygone.PersistenceTests.RavenDb
{
    ...
    public class RavenDbEventStoreReadTests : EventStoreReadTests
    {
        private IDocumentStore _store;

        public RavenDbEventStoreReadTests(ITestOutputHelper testOutputHelper, TestConfiguration config, RavenDbTestContext ctx) : base(testOutputHelper, config)
        {
