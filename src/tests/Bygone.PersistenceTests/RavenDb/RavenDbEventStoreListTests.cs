...
namespace Bygone.PersistenceTests.RavenDb
{
    ...
    public class RavenDbEEventStoreListStreamsTests : EventStoreListStreamsTests
    {
        private IDocumentStore _store;

        public RavenDbEEventStoreListStreamsTests(ITestOutputHelper testOutputHelper, TestConfiguration config, RavenDbTestContext ctx) : base(testOutputHelper, config)
        {
