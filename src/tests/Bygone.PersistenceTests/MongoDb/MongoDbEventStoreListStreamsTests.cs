...
{
    public class MongoDbEventStoreListStreamsTests : EventStoreListStreamsTests
    {
        private readonly string _collectionName;

        public MongoDbEventStoreListStreamsTests(ITestOutputHelper testOutputHelper, TestConfiguration config) : base(testOutputHelper, config)
        {
