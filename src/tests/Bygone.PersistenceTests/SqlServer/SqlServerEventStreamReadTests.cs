...
{
    public class SqlServerEventStreamReadTests : EventStreamReadTests
    {
        public SqlServerEventStreamReadTests(ITestOutputHelper testOutputHelper, TestConfiguration config) : base(testOutputHelper, config)
        {
