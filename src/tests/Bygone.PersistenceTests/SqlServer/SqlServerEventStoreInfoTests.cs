...
{
    public class SqlServerEventStoreInfoTests : EventStoreInfoTests
    {
        private string _tableName;

        public SqlServerEventStoreInfoTests(ITestOutputHelper testOutputHelper, TestConfiguration config) : base(testOutputHelper, config)
        {
